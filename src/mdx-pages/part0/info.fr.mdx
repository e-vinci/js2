...
| 43 | 21-25/10 | S10 | IHM | Les collections de composants | collections | 2.4 |
|  | | S11 | IHM | Destructuring & composants stateful | start-state | 2.5 & 2.6 |
| 44 | 28/10-1/11 congé |  |  |  |  |  |
...
|  |  | S16 | IHM | Fetch & promesses & useEffect | fetch-no-proxy | 2.13 |
| 48 | 25-29/11 | S17 | IHM | Evénements temporels & async-await | async-await | 2.14 |
|  |  | S18 | IHM | Les fonctions asynchrone & le proxy | async-await & proxy | 2.15 |
| 49 | 02-06/12 | S19 | Sécurisation (API) | CORS & autorisation d'origines & sécurisation d'une API | cors & auths | 3.1 |
|  |  | S20 | Sécurisation (API) | Sécurisation d'une API | (cookies) | (3.2) |
| 50 | 09-13/12/12 | S21 | Sécurisation (IHM) | Browser storage, authentification & opérations protégées par JWT | session-jwt | 3.3 |
|  |  | S22 | Sécurisation (IHM) | Authentification & opérations protégées par JWT (& cookies) | session-jwt | 3.4 |
...
|---|---|---|
| **C1 : Créer des services web** incluant **C3 : Sécurisation de SPA**| **1. Qualité du service web produit** <br/><i>Indicateurs : fonctionnel, respect des consignes</i>|65%|
| **C1 : Créer des IHM pour SPA** incluant **C3 : Sécurisation de SPA**| **2. Qualité de l’IHM produite** <br/><i>Indicateurs : fonctionnel, respect des consignes</i>|35%|
