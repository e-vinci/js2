...
Nous allons maintenant découvrir notre toute première RESTful API permettant de gérer les données associées à une pizzeria, afin de bénéficier d'opérations sur des ressources de type "pizzas".
...
Voici une partie du code qui pourrait se trouver au sein d'un router de pizzas, dans un fichier **`/routes/pizzas.js`** :
