...
# a) Destructuring et l'état

<InternalPageMenu>
  <PathViewer>
    <PathViewerItem to="/"> web2course </PathViewerItem>
    <PathViewerItem to="/part2"> Partie 2 </PathViewerItem>
    <PathViewerItem selected> a) Destructuring et l'état </PathViewerItem>
  </PathViewer>
...
Pour ce tutoriel, veuillez créer une copie du tutoriel `collections`, si nécessaire voici le code du tutoriel [collections](https://github.com/e-vinci/ts-demos/tree/main/front/collections), et l'appeler `start-state`. Changer le nom du projet dans `package.json`.
