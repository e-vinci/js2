...
# a) Les modules et collections

<InternalPageMenu>
  <PathViewer>
    <PathViewerItem to="/"> web2course </PathViewerItem>
    <PathViewerItem to="/part2"> Partie 2 </PathViewerItem>
    <PathViewerItem selected> a) Les modules et collections</PathViewerItem>
  </PathViewer>
...
Pour ce tutoriel, veuillez créer une copie du tutoriel `components`, si nécessaire voici le code du tutoriel [components](https://github.com/e-vinci/ts-demos/tree/main/front/components), et l'appeler `collections`. Changer le nom du projet dans `package.json`.
