...
<InternalPageMenu>
  <PathViewer>
    ...
    <PathViewerItem selected> d) L'état plus avancé </PathViewerItem>
  </PathViewer>
  <InternalPageMenuItem> Comment gérer un formulaire en React ?  </InternalPageMenuItem>
  <InternalPageMenuItem> Formulaire non contrôlé par React </InternalPageMenuItem>
  <InternalPageMenuItem> L' objet "event" </InternalPageMenuItem>
  <InternalPageMenuItem> Formulaire contrôlé par React </InternalPageMenuItem>
  <InternalPageMenuItem> Gérer une collection comme état de l'application </InternalPageMenuItem>
  <InternalPageMenuItem> Mise à jour de l'état en React </InternalPageMenuItem>
  <InternalPageMenuItem> Exercice 2.7 : Gestion d'une collection pour l'état </InternalPageMenuItem>
  <InternalPageMenuItem> Gestion d'un état partagé par plusieurs composants </InternalPageMenuItem>
  <InternalPageMenuItem> Debugging d'une application React </InternalPageMenuItem>
  <InternalPageMenuItem> 🍬 Challenge optionnel 2.8 : gestion d'un état partagé </InternalPageMenuItem>
</InternalPageMenu>

# <InternalPageTitle> Comment gérer un formulaire en React ?   </InternalPageTitle>
...
Pour ce tutoriel, veuillez créer une copie du tutoriel `start-state`, si nécessaire voici le code du tutoriel [start-state](https://github.com/e-vinci/ts-demos/tree/main/front/start-state), et l'appeler `medium-state`. Changez le nom du projet dans `package.json`.
...
# <InternalPageTitle> Formulaire non contrôlé par React  </InternalPageTitle>
...
# <InternalPageTitle> Formulaire contrôlé par React  </InternalPageTitle>
...
```tsx numbered highlighting="2-3,10-14,16-20,39,43,48,52"
const Main = () => {
...
# <InternalPageTitle> Gérer une collection comme état de l'application  </InternalPageTitle>
...
```tsx numbered highlighting="1,4-6,8,18-23"
...
```tsx numbered highlighting="1-27,32,58,62"
const defaultPizzas = [
  {
    id: 1,
    title: "4 fromages",
...
# <InternalPageTitle> Mise à jour de l'état en React </InternalPageTitle>
...
```tsx numbered highlighting="43-53,132-134"
...
# <InternalPageTitle> Exercice 2.7 : Gestion d'une collection pour l'état  </InternalPageTitle>
...
# <InternalPageTitle> Gestion d'un état partagé par plusieurs composants  </InternalPageTitle>
...
```tsx numbered highlighting="8,44-47,65"
...
Si nécessaire, vous pouvez trouver le code associé à ce tutoriel ici : [medium-state](https://github.com/e-vinci/ts-demos/tree/main/front/medium-state).

# <InternalPageTitle> Debugging d'une application React  </InternalPageTitle>
...
# <InternalPageTitle> 🍬 Challenge optionnel 2.8 : gestion d'un état partagé  </InternalPageTitle>
