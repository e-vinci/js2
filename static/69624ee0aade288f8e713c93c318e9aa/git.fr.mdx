...
# e) Introduction à Git

<InternalPageMenu>
  <PathViewer>
    <PathViewerItem to="/"> web2course </PathViewerItem>
    <PathViewerItem to="/part0" > Partie 0 </PathViewerItem>
    <PathViewerItem selected> e) Git</PathViewerItem>
  </PathViewer>
...
.vscode
# ignore the specific packages versions installed by the developer
package-lock.json
...
Pour les étudiants Vinci, comme vos cours de DevOps sont donnés sur GitHub, nous vous recommandons de créer un web repo sur GitHub. Pour ce faire, vous pouvez utiliser un compte existant ou en créer un nouveau sur https://github.com/. 
...
Pour trouver le lien vers votre repo,dans GitHub : cliquez sur le bouton **`Code`** dans votre web repo, et copiez l'info associée à l'onglet **`HTTPS`**.
