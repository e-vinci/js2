...
Pour ce tutoriel, veuillez créer une copie de la solution de l'exercice `2.8`, si nécessaire voici le code de [ex2.8](https://github.com/e-vinci/ts-exercises/tree/main/ex2.8), et l'appeler `ui-library`. Changez le nom du projet dans `package.json`.
